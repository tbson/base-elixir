...
export class Service {
    static get toggleEvent() {
        return "TOGGLE_UPDATE_ASSISTANT_PROFILE_DIALOG";
    }
...
export default function UpdateAssistantProfile({ onChange }) {
    ...
    return (
        <Modal
            ...
            cancelText={t`Cancel`}
            title={t`Update assistant profile`}
        >
            <Form
                data={data}
                onChange={(data) => {
...
UpdateAssistantProfile.displayName = "UpdateAssistantProfile";
UpdateAssistantProfile.toggle = Service.toggle;
