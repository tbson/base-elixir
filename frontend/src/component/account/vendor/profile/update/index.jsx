...
export class Service {
    static get toggleEvent() {
        return "TOGGLE_UPDATE_VENDOR_PROFILE_DIALOG";
    }
...
export default function UpdateVendorProfile({ onChange }) {
...
UpdateVendorProfile.displayName = "UpdateVendorProfile";
UpdateVendorProfile.toggle = Service.toggle;
