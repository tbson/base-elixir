...
export default function UpdateAdminProfile({ onChange }) {
...
UpdateAdminProfile.displayName = "UpdateAdminProfile";
UpdateAdminProfile.toggle = Service.toggle;
