...
import { BoolDisplay } from "component/common/display";
...
const INVITE_EMPLOYEE = "InviteEmployee";

export default function EmployeeCrudTable() {
    ...
    const [_employeeOption, setEmployeeOption] = useRecoilState(employeeOptionSt);
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: "enabled",
            render: (enabled) => <BoolDisplay value={enabled} />,
            width: 100,
            sorter: true
        },
        {
            key: "action",
            title: (
                <PemCheck pem_group={INVITE_EMPLOYEE} pem="invite_employee">
...
EmployeeCrudTable.displayName = "EmployeeCrudTable";
