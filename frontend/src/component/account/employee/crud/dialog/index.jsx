...
export class Service {
    static get toggleEvent() {
        return "TOGGLE_EMPLOYEE_CRUD_DIALOG";
    }
 ...
 */
export default function EmployeeCrudDialog({ onChange }) {
    ...
    const Form = id ? UpdateForm : InviteForm;
...
EmployeeCrudDialog.displayName = "EmployeeCrudDialog";
EmployeeCrudDialog.toggle = Service.toggle;
