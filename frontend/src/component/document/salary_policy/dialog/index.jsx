...
export class Service {
    static get toggleEvent() {
        return "TOGGLE_SALARY_POLICY_DIALOG";
    }
 ...
 */
export default function SalaryPolicyDialog({ onChange }) {
...
SalaryPolicyDialog.displayName = "SalaryPolicyDialog";
SalaryPolicyDialog.toggle = Service.toggle;
