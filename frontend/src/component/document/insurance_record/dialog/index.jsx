...
export class Service {
    static get toggleEvent() {
        return "TOGGLE_INSURANCE_DIALOG";
    }
 ...
 */
export default function InsuranceRecordDialog({ onChange }) {
...
InsuranceRecordDialog.displayName = "InsuranceRecordDialog";
InsuranceRecordDialog.toggle = Service.toggle;
