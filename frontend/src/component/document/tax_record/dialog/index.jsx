...
export class Service {
    static get toggleEvent() {
        return "TOGGLE_TAX_RECORD_DIALOG";
    }
 ...
 */
export default function TaxRecordDialog({ onChange }) {
...
TaxRecordDialog.displayName = "TaxRecordDialog";
TaxRecordDialog.toggle = Service.toggle;
