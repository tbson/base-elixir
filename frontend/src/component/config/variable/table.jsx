...
export default function VariableTable() {
    ...
    const [variableOption, setVariableOption] = useRecoilState(variableOptionSt);
    ...
    function getList() {
        ...
        return RequestUtil.apiCall(urls.crud, params)
            .then((data) => {
                ...
                setVariableOption(OptionUtil.getAllOptions(data.extra.option));
            })
            .finally(() => {
                setLoading(false);
            });
    ...
    const columns = [
        ...
        },
        {
            ...
            filters: variableOption.variableType.filterOptions,
            render: (value) => variableOption.variableType.mapOptions[value]
        },
        {
            key: "action",
            title: (
