...
const PEM_GROUP = "AssigningCompany";

export default function AssigningCompanyTable() {
    ...
    const [assigningCompanyOption, setAssigningCompanyOption] = useRecoilState(
        assigningCompanyOptionSt
    );
    ...
    function getList() {
        ...
        return RequestUtil.apiCall(urls.crud, params)
            .then((data) => {
                ...
                setAssigningCompanyOption(OptionUtil.getAllOptions(data.extra.option));
            })
            .finally(() => {
                setLoading(false);
            });
    ...
    const columns = [
        ...
        {
            key: "staff.name",
            title: labels.staff_name,
            dataIndex: ["staff", "name"]
        },
        {
            key: "assigning_admin.name",
            title: labels.assigner,
            dataIndex: ["assigning_admin", "name"]
        },
        {
            key: "action",
            title: (
...
AssigningCompanyTable.displayName = "AssigningCompanyTable";
