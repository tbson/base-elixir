...
export class Service {
    static get toggleEvent() {
        return "TOGGLE_ASSIGNING_COMPANY_DIALOG";
    }
...
/**
 * AssigningCompanyDialog.
 *
 * @param {Object} props
 * @param {function} props.onChange - (data: Dict, id: number) => void
 */
export default function AssigningCompanyDialog({ onChange }) {
...
AssigningCompanyDialog.displayName = "AssigningCompanyDialog";
AssigningCompanyDialog.toggle = Service.toggle;
