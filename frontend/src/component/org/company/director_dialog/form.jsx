...
import { directorUrls, labels } from "../config";

const formName = "DirectorForm";
const emptyRecord = {
    name: "",
    email: "",
    mobile: "",
 ...
 */
export default function DirectorForm({ data, onChange }) {
    ...
    const endPoint = id ? `${directorUrls.crud}${id}` : directorUrls.crud;
...
DirectorForm.displayName = formName;
DirectorForm.formName = formName;
