...
import { assistantUrls as urls } from "../config";

export class Service {
    static get toggleEvent() {
        return "TOGGLE_ASSISTANT_DIALOG";
    }
 ...
 */
export default function AssistantDialog({ onChange }) {
...
AssistantDialog.toggle = Service.toggle;
